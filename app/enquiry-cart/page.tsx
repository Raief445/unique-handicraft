        ...
        <div className={styles.cartItems}>
          ...
          {items.map((item) => {
            ...
            if (item.image && item.image.includes("ef15550c65982fbcef8bb04703c2918f")) {
              validImage = "https://images.unsplash.com/photo-1503602642458-232111445657?q=80&w=800&auto=format&fit=crop"; // Stool
            } else if (item.image && item.image.includes("eb491f9f0cbbcc0bc1b52015382d0e3f")) {
              validImage = "https://images.unsplash.com/photo-1618220179428-22790b46a013?q=80&w=800&auto=format&fit=crop"; // Mirror
            } else if (item.image && item.image.includes("img.sanishtech.com")) {
              validImage = fallbackSvg;
            }
